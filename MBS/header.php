...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <script src='https://www.google.com/recaptcha/api.js?render=6LffswIaAAAAADjd9N01xHFNz9Gqp_LPFRrkzL9_'></script>
  ...
  <header id="masthead" class="site-header">
    ...
    <nav id="site-navigation" class="main-navigation">
      <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'mbs' ); ?></button>
